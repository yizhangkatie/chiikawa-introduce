...
const FirstPost = () => {
  const images = ['/images/chii_anime1.jpg', '/images/chii_anime2.jpg'];
      ...
      <main className="relative flex flex-col h-full items-center justify-center space-y-3 py-8 ">
        ...
        <div className="relative bottom-0 w-full h-48 ">
          <div className="relative w-48 h-48 ">
            ...
            <img
              src="/images/chii_anime2.jpg"
              alt="chii"
              className="absolute bottom-0 left-4 w-full h-full opacity-0 hover:opacity-100 transition-opacity duration-400 object-contain"
            ></img>
          </div>
        </div>
