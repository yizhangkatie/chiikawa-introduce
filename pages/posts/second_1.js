    ...
    <div className='m-auto w-full text-center'>
        ...
        <div class="relative w-full h-screen bg-cover ">
            <div class="absolute left-0 flex items-center h-full">
                <img src="/images/role_hachiware.jpg" alt="bg_hachiware" class="w-auto h-screen object-contain mt-12"/>
                <div class="absolute inset-0 flex flex-col items-center justify-center">
                    <img src="/images/hachiware.jpg" alt="role_hachiware" class="w-36 h-36 object-contain rounded-full"/>
