        ...
        <div className="relative flex items-center h-full">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pb-12">
            ...
            <div className="text-left p-4 w-full max-w-xs">
              ...
              <p className="mb-2  inline">ちいかわ</p>
              <br />
              <p className="font-semibold mb-2 inline">誕生日：</p>
              <p className="mb-2  inline">2017年 ５月１日</p>
              <br />

              <p className="font-semibold mb-2 inline">紹介：</p>
              <p className="mb-2 inline">chiikawaの主人公</p>
              <br />

              <p className="font-semibold mb-2 inline">武器：</p>
              <p className="mb-2  inline">ピンク色のさすまた</p>
              <br />

              <p className="font-semibold mb-2 inline">性格：</p>
              <p className="mb-2  inline">臆病でシャイな性格</p>
              <br />

              <p className="font-semibold mb-2 inline">能力：</p>
              <p className="mb-2 inline">草むしり検定5級の合格に向けて勉強中</p>
              <br />
              <br />
            </div>
          </div>
            ...
            text={
              <>
                <span style={{ paddingLeft: '2em' }}>
                  セリフで表現されるのは「フ!」「わぁ~……」「わァ…ァ…」などの2~3文字程度の短い単語のみで、具体的な言葉は話さない。
                  自分が嫌な時は「イヤッ」や「ヤダッ」と明確に発音して拒否反応を示す。
                  <br />
                </span>
                <span style={{ paddingLeft: '2em' }}>
