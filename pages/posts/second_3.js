            ...
            text={
              <>
                <span style={{ paddingLeft: '2em' }}>
                  人語を話すことは無い、常に「ハァ？」 「ウラ」 「ヤハ」
                  「プルャ」 といった奇声めいた鳴き声を発している。
                  特に「フルルルルルルァーイ！」という巻き舌染みた鳴き声が特徴。
                  <br />
                </span>
                <span style={{ paddingLeft: '2em' }}>
                  普段どんな生活をしているか謎で、津々浦々旅行するのが好きらしい。
                  呪いのアイテムをよく買ってきてしまう。常にテンションが高く自由奔放に振る舞い、時にはトラブルメーカーのような一面もあるが、
                  <a href="./second_2">ちいかわ</a>や
                  <a href="./second_1">ハチワレ</a>
                  がピンチの時に助けたり、サポートをしたりする友達思いの面も多くある。
                </span>
              </>
            }
          />
