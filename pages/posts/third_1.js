    ...
    <div className="m-auto w-full text-center pt-12 lg:pt-16">
      <div className="relative flex w-full h-full lg:h-content bg-cover flex-col lg:flex-row">
        <div className="relative flex items-center h-full">
          <img
            src="/images/role_shisa.jpg"
            alt="role_shisa"
            className="w-full h-full object-contain"
          />
          <div className="absolute inset-0 flex flex-col items-center justify-center ">
            <img
              src="/images/shisa.jpg"
              alt="shisa"
            ...
            text={
              <>
                <span style={{ paddingLeft: '2em' }}>
                  食事関係の事で絡むことが多く、
                  <a href="./third_4">栗まんじゅう</a>
                  と並ぶグルメレポートキャラ。
                  また、沖縄関連のグルメや情報を出してくる事も多い
                  <br />
                </span>
                <span style={{ paddingLeft: '2em' }}>
                  ラーメン屋の「郎」でバイトをするなど、サービス業を行っている(スーパーアルバイターという資格を持っている)。
                  郎のマスター(黄色い鎧さん)を「お師匠」と呼ぶ。
                  現在は、お酒の資格を取得するために勉強をしており、お師匠とお酒を飲むのが夢。
                </span>
              </>
            }
          />
