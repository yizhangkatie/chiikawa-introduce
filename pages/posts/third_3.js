    ...
    <div className="m-auto w-full text-center pt-12 lg:pt-16">
      <div className="relative flex w-full h-full lg:h-content bg-cover flex-col lg:flex-row">
        <div className="relative flex items-center h-full">
          <img
            src="/images/role_huruhon.jpg"
            alt="bg_huruhon"
            className="w-full h-full object-contain"
          />
          <div className="absolute inset-0 flex flex-col items-center justify-center ">
            <img
              src="/images/huruhon.jpg"
              alt="role_huruhon"
            ...
            text={
              <>
                <span style={{ paddingLeft: '2em' }}>
                  古本屋を営んでいることからも覗えるように読書や本が好きで、本に関係することでは積極的な様子を見せる。
                  討伐の仕事もしているらしい、一人で討伐に行っているとおぼしき描写がある。
                  <br />
                </span>
                <span style={{ paddingLeft: '2em' }}>
                  また、<a href="./third_2">モモンガ</a>{' '}
                  が一本ツノちゃんの慟哭にちょっかいをかけようとした時にはモモンガを食事に誘う形で止めており、他者に対する気遣いや心配りができる気質も持っている。
                </span>
              </>
            }
          />
