        ...
        <div className="relative flex items-center h-full">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center ">
            ...
            <div className="text-left p-6 w-full max-w-xs">
              ...
              <p className="inline">ラッコ</p>
              <br />
              <p className="font-semibold mb-2 inline">誕生日：</p>
              <p className="inline">2021年 1月 24日</p>
              <br />
              ...
              <p className="mb-2  inline">非常に頼り甲斐があり</p>
              <br />
            </div>
          </div>
        </div>
            ...
            text={
              <>
                <span style={{ paddingLeft: '2em' }}>
                  孤高の強者的な雰囲気を漂わせており、基本的には単独で行動している。ハチワレ同様流暢に話すことができる。
                  主に「討伐」の仕事をしており、危険の絶えないちいかわ世界の中でも屈指の実力者。
                  自動車の運転免許および自家用車を持っている。
                  <br />
                </span>
                <span style={{ paddingLeft: '2em' }}>
                  筋金入りの甘党であり、ケーキやパフェに目がないという意外な一面がある。
